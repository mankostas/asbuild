...
export const routes = [
  ...
  },
  {
    ...
    meta: {
      requiresAuth: true,
      requiredAbilities: ['task_types.create', 'task_types.manage', 'task_type_versions.manage'],
  ...
  },
  {
    ...
    meta: {
      requiresAuth: true,
      requiredAbilities: ['task_types.update', 'task_types.manage', 'task_type_versions.manage'],
